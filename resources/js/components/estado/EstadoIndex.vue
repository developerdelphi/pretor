<template>
    <div>
        <div class="ui items">
            <Heading icone="flag" titulo="Estados" subtitulo="Listagem de Estados Brasileiros"></Heading>
            <Search :total="params.total" @click.native="index">
                <div class="field">
                    <input v-model="filters.sigla" type="text" placeholder="Sigla" @keyup.enter="index()" >
                </div>
                <div class="field">
                    <input v-model="filters.descricao" type="text" placeholder="Nome do Estado" @keyup.enter="index()" >
                </div>
            </Search>
        </div>
