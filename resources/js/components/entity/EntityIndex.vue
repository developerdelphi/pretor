          ...
          <v-card-text>
            <v-container grid-list-md>
              <v-layout wrap>
                ...
                <v-flex xs12 sm6 md4>
                  <v-text-field v-model="table.name" label="Entidades"></v-text-field>
                </v-flex>
          ...
          <tr @click="props.expanded = !props.expanded">
            ...
            <td class="justify-center layout right px-0">
              ...
              <v-btn
                ...
                dark
                small
                @click="deleteData(props.item.id, 'entities')"
                color="red darken-4"
              >
...
export default {
  ...
  data() {
    return {
      ...
      status: null,
      headers: [
        { text: "Entidade", align: "center", sortable: true, value: "name" },
      ]
    };
  },
  mounted() {
